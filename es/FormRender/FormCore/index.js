...
import { getSessionItem, immediateWatch, msToTime, setSessionItem, transformFieldsError, valuesWatch, yymmdd } from "../models/formCoreUtils";
import transformProps from "../models/transformProps";
import { _cloneDeep, isFunction, valueRemoveUndefined } from "../utils";
import "./index.less";
import { jsx as _jsx } from "react/jsx-runtime";
import { jsxs as _jsxs } from "react/jsx-runtime";
var FormCore = /*#__PURE__*/memo(function (props) {
  var store = useContext(FormRenderContext);
  var schema = useStore(store, function (state) {
    return state.schema;
  });
  var flattSchema = useStore(store, function (state) {
  ...
  var _ref = schema || {},
    ...
    schemaProps = _objectWithoutProperties(_ref, _excluded);
  var _transformProps = transformProps(_objectSpread(_objectSpread({}, props), schemaProps)),
    formProps = _transformProps.formProps,
    beforeFinish = _transformProps.beforeFinish,
    _transformProps$watch = _transformProps.watch,
    watch = _transformProps$watch === void 0 ? {} : _transformProps$watch,
    ...
    hiddenSubmitButton = _transformProps.hiddenSubmitButton,
    hasExportButton = _transformProps.hasExportButton,
    exportFunc = _transformProps.exportFunc;
  ...
  useEffect(function () {
    var context = {
      ...
      fieldCol: fieldCol,
      maxWidth: maxWidth,
      layout: formProps === null || formProps === void 0 ? void 0 : formProps.layout
    };
    setContext(context);
  ...
  var handleFinish = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_values) {
  ...
  var handleFinishFailed = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 3:
            values = cloneDeep((params === null || params === void 0 ? void 0 : params.values) || {});
            if (!removeHiddenData) {
              values = cloneDeep(form.getFieldsValue(true));
            }
            values = parseValuesToBind(values, flattSchema);
    ...
    return function handleFinishFailed(_x2) {
      return _ref4.apply(this, arguments);
    };
  }();
  var handleValuesChange = function handleValuesChange(changedValues, _allValues) {
    var allValues = valueRemoveUndefined(_allValues);
    valuesWatch(changedValues, allValues, watch);
  };

  // 创建一个防抖函数
  var throttledOnValuesChange = debounce(handleValuesChange, 500);
  var exportClick = function exportClick() {
    if (isFunction(exportFunc)) {
      exportFunc({
        physicalName: schema === null || schema === void 0 ? void 0 : schema.key
      });
    }
  };
  var importBefore = function importBefore(file) {
    var fileRender = new FileReader();
    fileRender.readAsText(file, 'utf-8');
    fileRender.onload = function (res) {
      var result = res.target.result;
      var data = result && result.length > 0 ? JSON.parse(result) : {};
      form.setFieldsValue(data);
    };
  };
  return schema && Object.keys(schema).length > 0 && /*#__PURE__*/_jsx("div", {
    className: "form-wrapper ".concat(readOnly ? 's-render-read-only' : ''),
    children: /*#__PURE__*/_jsxs(_Form, _objectSpread(_objectSpread({}, formProps), {}, {
      form: form,
      labelWrap: true,
      ...
      children: [schema && /*#__PURE__*/_jsx(_Row, {
        gutter: 24,
        children: /*#__PURE__*/_jsx(_Col, {
          ...
          children: /*#__PURE__*/_jsx("div", {
            ...
            children: /*#__PURE__*/_jsxs(_Space, {
              children: [!readOnly && [!hiddenSubmitButton && /*#__PURE__*/_jsx(_Button, {
                type: "primary",
                htmlType: "submit",
                children: "\u63D0\u4EA4"
              }, "submit"), /*#__PURE__*/_jsx(_Button, {
                onClick: onReset,
                children: "\u91CD\u7F6E"
              }, "reset"), /*#__PURE__*/_jsx(_Upload, {
              ...
              }, "import")], hasExportButton && /*#__PURE__*/_jsx(_Button, {
        ...
        gutter: 24,
        children: [/*#__PURE__*/_jsx(RenderCore, {
